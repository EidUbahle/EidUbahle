...
GO
INSERT INTO Users (Username, FullName, Email, PhoneNumber, PasswordHash, IsActive, MustChangePassword, CreatedDate) VALUES ('superadmin','WAMO Super Admin','admin@wamo.local','+252611234567','PBKDF2$sha256$120000$cTwJBVdnfCpNT9E5aMvWeg==$tGV5U3J8nptXdMKmj5/ARXKeMB3uKWyoLMbSGTjREz4=',1,1,SYSUTCDATETIME()),('ahmed.hassan','Ahmed Hassan','ahmed@example.com','+252610000001','PBKDF2$sha256$120000$cTwJBVdnfCpNT9E5aMvWeg==$tGV5U3J8nptXdMKmj5/ARXKeMB3uKWyoLMbSGTjREz4=',1,0,SYSUTCDATETIME());
GO
...
GO
INSERT INTO SystemSettings (SettingKey, SettingValue, Category, Description, IsEncrypted) VALUES ('WhatsAppNumber','252611234567','Communication','Primary WhatsApp contact number',0),('WhatsAppMessageTemplate','Hello WAMO, I need assistance regarding {topic}.','Communication','Default WhatsApp template',0),('SessionInactivityMinutes','1440','Security','Configurable inactivity timeout in minutes',0),('SmtpHost','smtp.example.com','Email','SMTP host placeholder',0),('RequireHttps','false','Security','Set true in production behind HTTPS',0);
GO
